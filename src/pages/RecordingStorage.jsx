...
function RecordingStorage() {
    ...
    return (
        <div className="bg-white ml-48 h-screen rounded-l-3xl py-16 px-28 text-left overflow-y-scroll " >
            ...
            <AudioContent totalRecordings={totalRecordings} activeAudio={activeAudio} playing={playing} handlePlayPause={handlePlayPause}/>

            {/* Audio List Section */}
            <AudioList audioData={audioData} handleAudioClick={handleAudioClick} activeAudio={activeAudio} />
        </div>
    )
}
